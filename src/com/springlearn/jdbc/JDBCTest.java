...
public class JDBCTest {
		 ...
		 * 1. SQL 语句中的参数名和类的属性一致! 注意类之间的关联关系
		 * 2. 使用 SqlParameterSource 的 BeanPropertySqlParameterSource 实现类作为参数. 
		 */
		@Test
		public void testNamedParameterJdbcTemplate2(){
			String sql = "INSERT INTO employees(last_name, email, depi_id) "
					+ "VALUES(:lastName,:email,:id)";
		...
		public void testNamedParameterJdbcTemplate(){
			String sql = "INSERT INTO employees(last_name, email, depi_id) VALUES(:ln,:email,:deptid)";
		...
		public void testQueryForObject(){
			String sql = "SELECT id, last_name lastName, email, depi_id as \"department.id\" FROM employees WHERE id = ?";
		...
		public void testBatchUpdate() {
			String sql ="INSERT INTO EMPLOYEES(last_name,email,depi_id) VALUES(?,?,?)";
